...
public:
  ...
  // ~neutrino(){cout << "neutrino destruido";} //constructor y destructor de clase
  ...
  void set_estado(string flavor) {
    ...
    if (flavor==e) {
      ...
      gsl_vector_complex_set(estado,0,gsl_complex_rect(cos(this->get_theta(0))*cos(this->get_theta(2)),0));
      
      gsl_vector_complex_set(estado,1,gsl_complex_rect(sin(this->get_theta(0))*cos(this->get_theta(2)),0));
      
      gsl_vector_complex_set(estado,2,gsl_complex_mul_real(gsl_complex_conjugate(faseCP),sin(this->get_theta(2))));
      
    } else if (flavor==mu) {
      
      aux=-sin(this->get_theta(0))*cos(this->get_theta(1));
      aux2=gsl_complex_mul_real(faseCP,-cos(this->get_theta(0))*sin(this->get_theta(1))*sin(this->get_theta(2)));
      
      gsl_vector_complex_set(estado,0,gsl_complex_add_real(aux2,aux));
      
      aux3=cos(this->get_theta(0))*cos(this->get_theta(1));
      aux4=gsl_complex_mul_real(faseCP,-sin(this->get_theta(0))*sin(this->get_theta(1))*sin(this->get_theta(2)));
      
      gsl_vector_complex_set(estado,1,gsl_complex_add_real(aux4,aux3));
      
      gsl_vector_complex_set(estado,2,gsl_complex_rect(sin(this->get_theta(1))*cos(this->get_theta(2)),0));
      
    } else if (flavor==tau) {

      aux=sin(this->get_theta(0))*sin(this->get_theta(1));
      aux2=gsl_complex_mul_real(faseCP,-cos(this->get_theta(0))*cos(this->get_theta(1))*sin(this->get_theta(2)));

      gsl_vector_complex_set(estado,0,gsl_complex_add_real(aux2,aux));

      aux3=-cos(this->get_theta(0))*sin(this->get_theta(1));
      aux4=gsl_complex_mul_real(faseCP,-sin(this->get_theta(0))*cos(this->get_theta(1))*sin(this->get_theta(2)));

      gsl_vector_complex_set(estado,1,gsl_complex_add_real(aux4,aux3));

      gsl_vector_complex_set(estado,2,gsl_complex_rect(cos(this->get_theta(1))*cos(this->get_theta(2)),0));
